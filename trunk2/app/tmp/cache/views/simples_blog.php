...
<head>
    ...
    <title>News &bull; Simples - A CakePHP CMS</title>
    
    <meta name="description" content="" />
    
    <link rel="icon" href="/simples/favicon.ico" type="image/x-icon" />
    <link rel="shortcut icon" href="/simples/favicon.ico" type="image/x-icon" />
    <link rel="alternate" type="application/rss+xml" title="Simples Feed" href="/simples/posts/feed" />
    
    
	<link rel="stylesheet" type="text/css" href="/simples/css/simples/main.css" />
...
<body>
    ...
    <div id="wrap">
        ...
        <div id="header">   
            <h1><a href="/simples/"><span>News &bull; simples - A CakePHP CMS</span></a></h1>
        </div>
        
        <hr />
        
        <ul><li class=""><a href="/simples/"><span>Home</span></a></li>
<li class=""><a href="/simples/feature-tour"><span>Feature tour</span></a></li>
<li class="current"><a href="/simples/blog"><span>Blog</span></a></li>
<li class=""><a href="/simples/documentation"><span>Documentation</span></a></li>
<li class=""><a href="/simples/contact"><span>Contact</span></a></li>
</ul>
        ...
        <h2><a href="/simples/blog/a-shiny-new-post">There are not many posts out there</a></h2>
...
<p>Sed risus mi, vestibulum ac, tincidunt at, condimentum id, tortor. Donec non mauris sed leo auctor auctor. Nullam facilisis. Quisque eu ipsum. Donec quis sem. Morbi rutrum magna in justo. Vestibulum eu orci. Praesent placerat, ipsum eget bibendum vulputate, velit dolor ultrices metus, tempus congue est lorem a eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nam consectetuer erat et urna.</p>
                ...
                <p class="postmeta">Posted in <a href="/simples/tag/personal-develompent">Personal Development</a>.</p>
                
        <p class="edit-this"><a href="/simples/admin/posts/edit/1">Edit</a></p>        
    </div>
        <div class="post" id="post-27">
        <h2><a href="/simples/blog/my-new-post">my new post</a></h2>
        ...
        <p class="edit-this"><a href="/simples/admin/posts/edit/27">Edit</a></p>        
    </div>
        <div class="post" id="post-26">
        <h2><a href="/simples/blog/lala-lala-la">lala lala la</a></h2>
        ...
        <p class="edit-this"><a href="/simples/admin/posts/edit/26">Edit</a></p>        
    </div>
        <div class="post" id="post-25">
        <h2><a href="/simples/blog/test">test</a></h2>
        <small class="post-date">Posted Sun, Aug 17th 2008, 18:02</small>
        
        <div class="entry">
            <p><img src="/simples/img/thumb/vetton_ru_501.jpg/120/120/1" alt="" /><img src="/simples/img/thumb/Good_Vibrations-1440x900.jpg/120/120/1" alt="" /></p>
<p>Abcdedfgh.</p>        </div>
        
                
        <p class="edit-this"><a href="/simples/admin/posts/edit/25">Edit</a></p>        
    </div>
        <div class="post" id="post-23">
        <h2><a href="/simples/blog/loool-post">loool post</a></h2>
        ...
        <p class="edit-this"><a href="/simples/admin/posts/edit/23">Edit</a></p>        
    </div>
        
    <div class="paginator"><span class="paginate-page paginate-prev">« Previous</span> <a href="/simples/blog" class="paginate-page current">1</a> <a href="/simples/blog/index/page:2" class="paginate-page">2</a> <a href="/simples/blog/index/page:2" class="paginate-page paginate-next">Next »</a></div>    
</div>
        ...
        <div id="footer">
	        <p>Powered by <img src="/simples/img/simples/small-logo.gif" alt="simples" class="wf-icon" /> <a href="/simples/">simples</a>. <span class="admin-link"><a href="/simples/admin">Site admin</a></span></p>
