<div class="wilflower-in-debug" style="background:#eee;font-size:14px;color:#000;
    ...
    <h6 style="margin:0 4px;font-size:14px;">Missing database table(s)</h6>
    <p style="background:#fff;color:#000;padding:3px;">
        The database connection is fine. But have you imported 
        <em>app/config/simples.sql</em> into your database?</p>
</div>