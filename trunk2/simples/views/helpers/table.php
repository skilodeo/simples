    ...
    function create($data, $settings = array()) {
        ...
        foreach ($data as $key => $node) {
            ...
            for ($i = 0; $i < $colsCount; $i++) {
                ...
                if ($i > 0 && strlen($cell) > Configure::read('Simples.table.maxlength')) {
                    $cell = mb_substr($cell, 0, Configure::read('Simples.table.maxlength'), Configure::read('App.encoding')) . "...";
                }
            ...
            switch ($controller) {
                ...
                case  'posts':
                    ...
                    $viewPath =  '/' + SIMPLES_POSTS_INDEX + "/$slug";
                    break;
                case 'pages':
