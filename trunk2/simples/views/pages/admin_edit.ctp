...
<?php
    ...
    $form->input('draft', array('type' => 'select', 'between' => '<br />', 'label' => 'Status', 'options' => Page::getStatusOptions())),
...
<div class="big-submit">
    ...
    <?php } ?>
    <p id="save-info">
        This page was last saved <abbr id="modified-time" title="<?php echo $time->nice($this->data['Page']['updated']) ?>"><?php echo $time->niceShort($this->data['Page']['updated']), '</abbr>'; if ($hasUser) { ?> 
