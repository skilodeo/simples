...
class PostsController extends AppController {
    ...
    function beforeFilter() {
    	...
    	$this->params['current']['slug'] = SIMPLES_POSTS_INDEX;
    }
    
    function beforeRender() {
        parent::beforeRender();
        $this->set('isPosts', true);
        $this->params['Simples']['view']['isPosts'] = true;
    }
     ...
     */
    function category() {
    	$slug = SimplesHelper::slug($this->params['slug']);
    ...
    function preview($fileName) {
        ...
        $this->params['breadcrumb'][] = array('title' => 'News', 'url' => '/' . SIMPLES_POSTS_INDEX);
