...
class UploadsController extends AppController {
	...
	function admin_create() {
        ...
        $uploadPath = Configure::read('Simples.uploadDirectory') . DS . $fileName;
        ...
        while (file_exists($uploadPath)) {
            ...
            $uploadPath = Configure::read('Simples.uploadDirectory') . DS . $newFileName;
	...
	function admin_delete($id = null) {
        ...
        // Delete files		
		$paths = array();
	    array_push($paths, Configure::read('Simples.uploadDirectory') . DS . $file['Upload']['name']);
	 ...
	 *
	 */
	function admin_insert_image($limit = 8) {
		$this->layout = '';
